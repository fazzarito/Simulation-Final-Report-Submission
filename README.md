...
- `main_report.ipynb` : complete analysis and findings (13 pages as a pdf, but submitted as .ipynb)
- `simulation.py` : demo implementation 
- `data/` :  saved experiment outputs (CSV) 
- `README.md` : this file.
